  ...
  return ( 
   ...
   <>
      <section className="side__bar">
        ...
        {Object.keys(cart.cart).map((key) => {
          ...
          return (
            ...
            <div className="side__bar__item">
              <img key={cart.cart[key].movie.id} className="poster_min" src={`https://image.tmdb.org/t/p/w342/${cart.cart[key].movie.poster_path}`} alt=""></img>
        ...
        <a className="side__bar__finish"  target="_blank">Finalizar compra</a>
    </section>
    </>
    </>
  )
